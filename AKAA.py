...
def countdown(t):
    ...
    while True:
        if (until - datetime.datetime.now()).total_seconds() > 0:
            ...
            stdout.flush()
            stdout.write(
                "\r " +Fore.MAGENTA+"[*]"+Fore.WHITE+" Xong Rồi Cu !                                   \n")
            return
...
def inputf():
    printf(Colorate.Vertical(Colors.yellow_to_red, '''
            root@manhducdz $>>''', True), end=' ')
...
def welcome():
  ...
  while True:
    ...
    if 'credits' in cmdl:
      ...
      printf(Center.XCenter(Colorate.Vertical(Colors.white_to_blue, f'''
                                    ╦══╩══════════════0══════════════════╩══╦
                                    ║        ╔═╗╦╔═╔═╗╔═╗╔╦╗╔╦╗╔═╗╔═╗       ║
                                    ║        ╠═╣╠╩╗╠═╣╠═╣ ║║ ║║║ ║╚═╗       ║
                                    ║        ╩ ╩╩ ╩╩ ╩╩ ╩═╩╝═╩╝╚═╝╚═╝       ║
      ...
      printf(Center.XCenter(Colorate.Vertical(Colors.red_to_blue, f'''
                  ...
                  ╔═════════╩═════════════════════════════════════╩═════════╗          
                  ║                                                         ║
                  ║    buvuuvuvu   >      tcp, udp, mine, vse, tcpcustom    ║  
                  ║                                                         ║ 
                  ║       layer4-7    >        cfb,sky, get, post, head,    ║
                  ║                          stellar, hulk, pxslow          ║
      ...
      '''), True), end='')
        ...
        clr()
        printf(Center.XCenter(Colorate.Vertical(Colors.red_to_white, f'''
                                                       ╦══╩══════════════0══════════════════╩══╦
                                                       ║         ╔═╗╦╔═╔═╗╔═╗╔╦╗╔╦╗╔═╗╔═╗      ║
                                                       ║         ╠═╣╠╩╗╠═╣╠═╣ ║║ ║║║ ║╚═╗      ║
                                                       ║         ╩ ╩╩ ╩╩ ╩╩ ╩═╩╝═╩╝╚═╝╚═╝      ║
                                                ...
                                                ╔═════════╩═════════════════════════════════╩═════════╗          
                                                ║                                                     ║
                                                ║    proxy              >  check proxie nào dùng được ║
                                                ║    proxie             >  tất cả proxie              ║
                                                ╠═════════╦══════════════$══════════════════╦═════════╣
                                                       ╦══╩═════════════════════════════════╩══╦
      '''), True), end='')
    ...
    ##################################################################################
      ...
      try:
        ...
        print((Colorate.Horizontal(Colors.red_to_purple, ' [!] Command Đéo Có.')))
    ######################################################################################
